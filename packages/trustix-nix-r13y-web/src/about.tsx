  ...
  return (
    <>
      ...
      <span class="py-4 mx-1">
        ...
        <p>
          This tool aggregates data from multiple{" "}
          <A href={homepageURL}>Trustix</A> log operators (i.e. builders) and
          cross compares them to establish reproducibility.
        </p>
        <p>
          Builds are run on a variety of platforms and hardware configurations.
        </p>
      </span>
      ...
      <span class="py-4 mx-1">
        ...
        <p>
          ...
          The quality of the results depend on the diverseness of builders, If
          all builders run the same CPU model the quality will be lower
        </p>
        <br />
        <p>
          It isn't possible to guarantee a package is reproducible, just like it
          isn't possible to prove software is bug-free. It is possible there is
      ...
      <span class="py-4 mx-1">
        ...
        <p>
          ...
          log to the{" "}
          <A class="underline" href={officialInstanceURL}>
            official Trustix R13y instance
          </A>
          .
          <br />
        ...
        <br />
        <p>
          Another thing you can do is to report issues and help to fix them at{" "}
          <A class="underline" href={homepageURL}>
            {homepageURL}
          </A>
          .
        </p>
      ...
      <span class="py-4 mx-1">
        ...
        <p>
          It's a homage to <A href="https://r13y.com">r13y.com</A> by{" "}
          <A href="https://github.com/grahamc">@grahamc</A> which started the
          reproducibility tracking effort for Nix/NixOS.
        </p>
      </span>
    </>
  );
