...
_LOGSRESPONSE_LOGSENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="trustix.LogsResponse.LogsEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="trustix.LogsResponse.LogsEntry.value",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
LogMeta = _reflection.GeneratedProtocolMessageType(
    "LogMeta",
    (_message.Message,),
    {
        "DESCRIPTOR": _LOGMETA,
...
LogsResponse = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        "LogsEntry": _reflection.GeneratedProtocolMessageType(
            "LogsEntry",
            (_message.Message,),
            {
